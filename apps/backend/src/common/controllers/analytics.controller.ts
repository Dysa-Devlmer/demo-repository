...
export class AnalyticsController {
  ...
  @ApiOperation({
    ...
    description: 'Record a new business metric for analytics and reporting purposes',
  })
  @ApiBody({
    schema: {
      type: 'object',
  ...
  @ApiOperation({
    ...
    description: 'Retrieve list of generated business reports with summary information',
  })
  @ApiQuery({
    name: 'limit',
    required: false,
  ...
  @ApiOperation({
    ...
    description: 'Create a new business report for the specified period and type',
  })
  @ApiBody({
    schema: {
      type: 'object',
  ...
  @ApiOperation({
    ...
    description: 'Retrieve detailed information for a specific business report by ID',
  })
  @ApiParam({
    name: 'id',
  ...
  @ApiOperation({
    ...
    description: 'Export a business report in the specified format (CSV, Excel, PDF, JSON)',
  })
  @ApiParam({
    name: 'id',
    description: 'Report ID',
  ...
  @ApiOperation({
    ...
    description: 'Retrieve AI-powered business insights and actionable recommendations',
  })
  @ApiResponse({
    status: 200,
    ...
    return {
      insights: [
        ...
        },
        {
          ...
          description: 'La calificación promedio de satisfacción se mantiene en 4.6/5.0',
          impact: 'high',
          confidence: 88.1,
        },
        {
          ...
          description: 'El tiempo promedio de preparación de pedidos ha disminuido un 12%',
          impact: 'medium',
          confidence: 79.5,
        },
        {
          ...
          description: 'Los productos más populares mantienen niveles de stock adecuados',
          impact: 'medium',
          confidence: 85.7,
        },
      ],
      recommendations: [
        {
          ...
          description: 'Implementar un sistema de puntos y recompensas para aumentar la retención',
          priority: 'high',
        ...
        },
        {
          ...
          description: 'Promover productos con mayor margen de ganancia durante horas pico',
          priority: 'high',
        ...
        },
        {
          ...
          description: 'Considerar extender horarios de atención basado en demanda histórica',
          priority: 'medium',
        ...
        },
        {
          ...
          description: 'Implementar campañas automáticas basadas en comportamiento del cliente',
          priority: 'medium',
  ...
  @ApiOperation({
    ...
    description: 'Check the health status of the analytics system and all its components',
  })
  @ApiResponse({
    status: 200,
