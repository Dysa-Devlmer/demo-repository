...
@Module({
  ...
  providers: [AuditMiddleware, AuditReviewService, SecurityAlertsService, LogArchivingService, ComplianceReportsService],
  exports: [AuditMiddleware, AuditReviewService, SecurityAlertsService, LogArchivingService, ComplianceReportsService],
})
