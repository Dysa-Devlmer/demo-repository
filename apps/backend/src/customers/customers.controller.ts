...
export class CustomersController {
  ...
  @ApiOperation({
    ...
    description:
      'Create a new customer record in the system. Requires admin, manager or staff role.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Retrieve a list of all customers in the system. Requires admin, manager or staff role.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Retrieve detailed information about a specific customer. Requires admin, manager or staff role.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Permanently delete a customer from the system. Requires admin or manager role. This action cannot be undone.',
  })
  @ApiParam({ name: 'id', description: 'Customer ID', type: Number })
